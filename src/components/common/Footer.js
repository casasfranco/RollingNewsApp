...
const Footer = () => {
  return (
    <section className="bg-light m-0 row justify-content-center">
      <article className="container mt-5 row justify-content-center">
